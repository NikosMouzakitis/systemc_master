...
/*****************************************************************************
  ...
  Description of Modification:  
                                - Inclusion of the PKtool header file (PKtool.h);
                                - The initiator_socket member has been 
								  converted into an augmented socket;
                                - typedef instruction for 
								  pk_tlm::tlm_initiator_socket_aug<32>
...
public:
  ...
  typedef pk_tlm::tlm_initiator_socket_aug<32>   initiator_socket_type_aug;  

public:
  initiator_socket_type_aug socket;
