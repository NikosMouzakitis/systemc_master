...
/*****************************************************************************
  ...
  Description of Modification:  - Introduction of the conditional
                                  macro PK_FIR_RTL;
                                - Inclusion of the header "power_modules.h";
								- fir_1 converted into a power_module.
...
int sc_main (int argc , char *argv[]) {
  ...
  POWER_MODULE(fir) fir1( "process_body");
  fir1.reset(reset); 
