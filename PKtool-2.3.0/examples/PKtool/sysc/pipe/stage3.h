...
struct stage3: sc_module {								//by this operation the input signals 1-2 on the input ports are increased
    sc_in_aug<double> prod;   //input 1
    sc_in_aug<double> quot;   //input 2
